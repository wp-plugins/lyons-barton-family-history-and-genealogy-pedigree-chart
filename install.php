...
function dashboard_widget_function() {
	...
	$wpdb->get_results( 'SELECT * FROM wp_wdl_pedigree_person' );
	echo  'You have '. $wpdb->num_rows . ' Family Members in your Tree';
	
	
}
// Function used in the action hook
function add_dashboard_widgets() {
	wp_add_dashboard_widget('dashboard_widget', 'LB Family History & Genealogy Pedigree Chart', 'dashboard_widget_function');
}
...
ob_start();
	...
	$result = $wpdb->get_results( "SELECT first_name, family_name, date_of_birth, date_of_death, sex, image FROM $table_name WHERE id = '$id'" );
...
<?php echo htmlspecialchars($family_name)?>
            
            </div> <!-- End of wdl_family_name div-->
            
            <div class="wdl_maiden_name"> 
            </div> <!-- End of wdl_family_name div-->
			<?php
            } else {
...
<?php
	...
	if (isset($f_gfather_result->post_id)) {
...
<?php
	...
	if (isset($f_gmother_result->post_id)) {
...
// Get values from form
	...
	$family_type= check_input($family_type, "You need to Choose The Type of Family Member");
...
if (isset($_POST['person_id'])){
	...
	$person_id= check_input($person_id, "You need to Choose The 1st Person");
